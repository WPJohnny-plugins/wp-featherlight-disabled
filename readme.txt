...
The most lightweight WordPress lightbox plugin...the featherlight CSS/JS (only 7kb) and automatically disabled unless you manually enable within each post.
